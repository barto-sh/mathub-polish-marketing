      ...
      <div className="container-mh relative z-10 py-16 md:py-20">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[2.2fr_1fr_1.1fr_1.2fr] lg:gap-12">
          ...
          <div>
            ...
            <p className="mt-[18px] max-w-[40ch] text-[14px] leading-relaxed text-paper/[0.58]">
              Przeprowadzki, transport bagażowy i atrakcje eventowe z dowozem.
              Jednoosobowa działalność z bazą w Trzeszczynie — rozmowa, praca
              i odpowiedzialność zostają po jednej stronie.
            </p>
          </div>
